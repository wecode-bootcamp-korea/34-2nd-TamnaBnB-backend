...
class RoomDetialTest(TestCase):
    def setUp(self):
        ...
        Reservation.objects.bulk_create([
            Reservation(
                ...
                reservation_number = "0000-0000-0001",
                accomodation_fee   = 50000.00,
                check_in_date      = "2022-8-1",
                check_out_date     = "2022-8-1",
                num_of_guest       = 5,
                num_of_pet         = 5,
                user_id            = 1,
                room_id            = 1,
    ...
    def test_success_room_detail(self):
    ...
    def test_room_does_not_exist_error(self):
        response = self.client.get("/rooms/125")
